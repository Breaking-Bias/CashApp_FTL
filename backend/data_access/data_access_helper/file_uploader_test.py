...
from data_access.data_access_helper.file_uploader import FileUploader  # Adjust this import as needed

@pytest.fixture
def file_uploader():
    upload_folder = 'test_data'
    allowed_extensions = {'txt', 'csv'}
    uploader = FileUploader(upload_folder=upload_folder, allowed_extensions=allowed_extensions)
    yield uploader
...
def test_list_datasets(file_uploader):
    ...
    for filename in filenames:
        with open(os.path.join(file_uploader.upload_folder, filename), 'w') as f:
