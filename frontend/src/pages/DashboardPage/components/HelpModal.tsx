      ...
      >
        <Box sx={style}>
          ...
          >
            ...
            specific bias was removed from the dataset. (represented by the
            shaded area)
          </Typography>
          <Box
            component="img"
          ...
          <Typography id="actions" variant="body1">
            ...
            <br />
            <strong>Prediction Size</strong>: Adjust the slider to define
            prediction size.
          </Typography>
          <Typography
            id="actions"
