...
function DashboardPage() {
  ...
  return (
    <div
      style={{ textAlign: "center", marginTop: "50px", padding: "10px 20px" }}
      aria-live="polite"
    >
      {/* Page Title */}
      <div
      ...
      <div style={{ display: "flex", height: "100vh", gap: "20px" }}>
        ...
        <div className="right-container">
          ...
          <Box display="flex" alignItems="center" justifyContent="center">
            ...
            >
              <IconButton
                aria-label="Help with prediction size slider"
          ...
          >
            ...
            />
            <Tooltip
              title="Choose Prediction Size and Filter first, then click on this button to visualize."
              sx={{ fontSize: "25px" }}
            >
              <IconButton
                aria-label="Make forecast button"
